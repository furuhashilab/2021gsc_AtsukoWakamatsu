...
個人的にな願いとしては豚カツ店の情報を収集する手段としてOSMをもっと自由に使ってほしいと考える。食べログや個人ブログなどを通して情報が更新されるような仕組みを作るためには何が出来るかを考えたい。
...
今後、とんかつ店だけでなく、日本の和食文化を広めるための一助としてのOSMが利用され、OPENなPOIデータ（店舗情報）の集約をどのようにして行っていくかを考えるために本研究が使われることを期待したい。
## 参考文献
